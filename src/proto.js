...
async function loadProto() {
  ...
  types.ReportArkClickRequest = root.lookupType(
    "gamepb.userpb.ReportArkClickRequest",
  );
  types.ReportArkClickReply = root.lookupType(
    "gamepb.userpb.ReportArkClickReply",
  );
  ...
  types.InsecticideRequest = root.lookupType(
    "gamepb.plantpb.InsecticideRequest",
  );
  types.InsecticideReply = root.lookupType("gamepb.plantpb.InsecticideReply");
  types.RemovePlantRequest = root.lookupType(
    "gamepb.plantpb.RemovePlantRequest",
  );
  ...
  // 商店
  types.ShopProfilesRequest = root.lookupType(
    "gamepb.shoppb.ShopProfilesRequest",
  );
  ...
  types.GetApplicationsRequest = root.lookupType(
    "gamepb.friendpb.GetApplicationsRequest",
  );
  types.GetApplicationsReply = root.lookupType(
    "gamepb.friendpb.GetApplicationsReply",
  );
  types.AcceptFriendsRequest = root.lookupType(
    "gamepb.friendpb.AcceptFriendsRequest",
  );
  types.AcceptFriendsReply = root.lookupType(
    "gamepb.friendpb.AcceptFriendsReply",
  );
  ...
  types.ClaimTaskRewardRequest = root.lookupType(
    "gamepb.taskpb.ClaimTaskRewardRequest",
  );
  types.ClaimTaskRewardReply = root.lookupType(
    "gamepb.taskpb.ClaimTaskRewardReply",
  );
  types.BatchClaimTaskRewardRequest = root.lookupType(
    "gamepb.taskpb.BatchClaimTaskRewardRequest",
  );
  types.BatchClaimTaskRewardReply = root.lookupType(
    "gamepb.taskpb.BatchClaimTaskRewardReply",
  );
  ...
  types.FriendApplicationReceivedNotify = root.lookupType(
    "gamepb.friendpb.FriendApplicationReceivedNotify",
  );
  types.FriendAddedNotify = root.lookupType(
    "gamepb.friendpb.FriendAddedNotify",
  );
